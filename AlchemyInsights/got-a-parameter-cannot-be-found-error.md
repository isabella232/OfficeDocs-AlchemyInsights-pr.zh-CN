...
许多大型组织需要仔细规划，以管理用户期望。 将 [IMAP 邮箱迁移到 Microsoft 365](https://docs.microsoft.com/Exchange/mailbox-migration/migrating-imap-mailboxes/migrating-imap-mailboxes) 一文中需要了解的内容将帮助您管理更改。 请注意， [不需要通过 IMAP 再执行](https://docs.microsoft.com/Exchange/mailbox-migration/perform-g-suite-migration) (Google) 迁移的 G 套件。
