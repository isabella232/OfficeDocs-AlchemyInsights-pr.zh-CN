...
2. [检查可拉](https://docs.microsoft.com/azure/active-directory/develop/active-directory-claims-mapping#table-3-valid-id-values-per-source) 取的已批准属性值，以针对每个源的有效 ID 值声明。
