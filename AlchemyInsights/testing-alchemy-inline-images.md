...
ms.locfileid: "36507153"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="33266-102">访问 "域" 页</span><span class="sxs-lookup"><span data-stu-id="33266-102">Access the Domains Page</span></span>

<span data-ttu-id="33266-103">若要访问 "域" 页面, 只需单击以下图标:</span><span class="sxs-lookup"><span data-stu-id="33266-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="33266-104">然后, 您可以添加、修改或删除您的域。</span><span class="sxs-lookup"><span data-stu-id="33266-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="33266-105">有关详细信息, 请参阅[域 FAQ。](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="33266-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
