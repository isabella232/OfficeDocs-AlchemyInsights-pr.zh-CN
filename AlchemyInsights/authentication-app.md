...
1. 如果用户未在 Microsoft Authenticator 应用中收到推送通知，请验证他们未显示在 MFA 阻止的用户下，如阻止和 [取消阻止用户中所述](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/diagnose/symptomId/ms_aad_dxp_signin_caDiagnoseAndSolveSummarySymptom)。
1. 如果未阻止用户进行 MFA，但没有收到推送通知，他们可以打开 Microsoft Authenticator 应用，这将拉取挂起的审批请求。
1. 作为备用登录方法，用户还可以单击"以其他方式登录"，然后从我的移动应用中选择使用验证码。
1. Microsoft Authenticator 应用是许多用户唯一可用的方法。 [详细了解安全默认值，请查看](https://docs.microsoft.com/azure/active-directory/fundamentals/concept-fundamentals-security-defaults) [Authenticator 应用常见问题](https://docs.microsoft.com/azure/active-directory/user-help/user-help-auth-app-faq) 解答，了解常见问题以及如何解决这些问题。
 
**建议的视频**

[如何在 2 分钟或 2 分钟的新手机上 (Authenticator) 。 ](https://go.microsoft.com/fwlink/?linkid=2158163&clcid=0x409)
