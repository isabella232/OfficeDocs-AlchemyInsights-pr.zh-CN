...
- 你可以在93天内恢复已删除的网站。 必须在30天内恢复已删除的组。 直接从[SharePoint 管理中心](https://admin.microsoft.com/sharepoint?page=home&modern=true)[查看和还原已删除的网站](https://admin.microsoft.com/sharepoint?page=recyclebin&modern=true)。 若要[查看和还原**已删除的组**](https://outlook.office.com/people/group/deleted)，请选择 "**管理组**"，然后选择 "**删除**"。
