...
ms.locfileid: "30779432"
---
# <a name="using-the-office-readiness-toolkit"></a>使用 Office 准备情况工具包

有关使用 office 准备情况工具包的信息, 请参阅[使用准备情况工具包评估适用于 office 365 的应用程序兼容性专业增强版](https://docs.microsoft.com/DeployOffice/use-the-readiness-toolkit-to-assess-application-compatibility-for-office-365-pro)。
