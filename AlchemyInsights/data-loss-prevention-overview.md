...
---
# <a name="data-loss-prevention-dlp-overview"></a>DLP) 的数据丢失防护 (概述
...
有关详细信息，请参阅以下 [文章](https://docs.microsoft.com/microsoft-365/compliance/data-loss-prevention-policies)。
