...
---
# <a name="fixing-the-microsoft-365-apps-the-products-we-found-in-your-account-cant-be-used-to-activate-message"></a>修复 Microsoft 365 应用程序 "无法使用我们在你的帐户中找到的产品来激活" 消息
...
有关共享计算机方案，请参阅[疑难解答 Microsoft 365 应用程序的共享计算机激活与企业相关的问题](https://docs.microsoft.com/deployoffice/troubleshoot-shared-computer-activation)。
