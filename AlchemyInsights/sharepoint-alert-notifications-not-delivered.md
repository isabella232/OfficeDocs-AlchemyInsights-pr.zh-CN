...
- **不传递单个警报**: 如果未传递来自特定文件或库的单个通知, 则可以尝试删除并重新创建它。 请参阅[管理、查看或删除 SharePoint 警报</a>以重新创建警报](https://support.office.com/article/manage-view-or-delete-sharepoint-alerts-99dfb19c-9a90-4a8c-aba1-aa8c8afb0de2#ID0EAADAAA=Online)。 
...
- **警报疑难解答**: 有关排除警报的详细信息, 请参阅[用户不接收 SharePoint Online 警报通知](https://support.office.com/article/users-don-t-receive-sharepoint-online-alert-notifications-14fc22dd-e873-482c-844d-f67ad41313f1)。
