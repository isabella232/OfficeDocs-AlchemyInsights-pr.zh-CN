...
2. 检查 "[撤消发送](https://outlook.live.com/mail/options/mail/messageContent/undoSend)未打开"。
3. 如果您的收件箱已满，将无法发送或接收新邮件。 右键单击 "**垃圾邮件** > **全部删除**" 以清空[垃圾邮件](https://outlook.live.com/mail/junkemail)。
4. 请确保您尝试发送的人员的电子邮件地址的格式正确。
5. 如果已连接的帐户超过20个，将无法发送或接收邮件。
