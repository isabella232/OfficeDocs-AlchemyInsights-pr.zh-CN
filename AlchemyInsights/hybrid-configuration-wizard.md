...
"混合配置" 向导是帮助您在内部部署 Exchange 组织和 Office 365 之间设置新的混合部署的应用程序。 如果已经设置了混合部署, 则向导将帮助您更新混合部署设置。 有关详细信息, 请参阅:
  
- [运行 "混合配置" 向导](https://technet.microsoft.com/library/mt595788%28v=exchg.150%29.aspx)
