...
---
# <a name="error-0-1036-when-installing-office"></a>安装 office 时出现错误0-1036


请尝试以下解决方案来修复你的 Office 错误 0-1036:
  
- 重新启动计算机, 然后再次尝试[安装 Office](https://portal.office.com/OLS/MySoftware.aspx) 。 
    
- 下载并安装[支持和恢复助手](https://aka.ms/SARA-OfficeUninstall-Alchemy)。
    
1. 在它打开时, 从 "**卸载 Office 产品**" 选择要卸载的版本, 然后选择 "**下一步**"。
