...
**"设置** > **查看所有 Outlook 设置** > **邮件** > **自动答复**打开您的[自动答复设置](https://outlook.live.com/mail/options/mail/automaticReplies)。
2. 选择 "**打开自动答复**" 切换。
