...
- 打开 Office 应用程序，选择 "**文件** > **帐户** > 注销**所有帐户**"。 使用具有有效许可证的用户帐户重新登录。 有关详细信息，请参阅[Office 中的账户](https://support.office.com/article/accounts-in-office-628ea040-f265-49de-b986-be09c3ebf8a9)。
