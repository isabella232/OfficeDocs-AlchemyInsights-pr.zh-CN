...
**注意：** 请确保您具有 [ 包括 Office 客户端应用](https://support.office.com/article/28cbc8cf-1332-4f04-9123-9b660abb629e) 的 Office 365 或 Microsoft 365 订阅，例如 Microsoft 365 商业标准版、Microsoft 365 商业应用版或 Microsoft 365 企业应用版。 此外，请确保您用于登录 Office 应用程序的用户帐户[已分配了许可证](/microsoft-365/admin/manage/assign-licenses-to-users)。
...
4. [重置 Office 激活状态](/office365/troubleshoot/activation/reset-office-365-proplus-activation-state)，然后使用新帐户[登录 Office](https://support.office.com/article/sign-in-to-office-b9582171-fd1f-4284-9846-bdd72bb28426) 应用。
