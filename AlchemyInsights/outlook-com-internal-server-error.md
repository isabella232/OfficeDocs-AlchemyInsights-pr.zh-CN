...
哦不！ 如果您看到 "错误 500" 或 "内部服务器错误" 消息, 则表示它是我们, 而不是你-抱歉。

签出 " [Office 服务状态" 页](https://portal.office.com/servicestatus)以确保不会发生任何其他操作, 但最好的解决方案是在几分钟内休息一下, 然后按**CTRL**和**F5**刷新浏览器。