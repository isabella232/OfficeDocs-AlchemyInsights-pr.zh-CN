...
用户可能会因密码尝试不当或其他威胁而被锁定，无法再使用 Office 365。 若要帮助用户重新登录到 Microsoft 365，**可在考虑开启支持请求之前先尝试执行以下步骤**。 
...
作为管理员，如果一个用户被限制发送邮件，可以[自行取消阻止账户](https://docs.microsoft.com/microsoft-365/security/office-365-security/removing-user-from-restricted-users-portal-after-spam)，**无需打开支持案例**。 用户在解除限制后一小时内无法发送邮件。
