...
1. **AlchemyInsights**文件夹中的文件应具有文件名中[Alchemy 合作伙伴门户](https://alchemyportal.azurewebsites.net)中的规则 ID 和规则名称。
    1. ex. ***976-启用-保留-保留***
1. 将此文件顶部的元数据用作模板。 不需要任何其他内容。
...
准备好内容后, 将其纳入活动分支。 然后, 转到 " [Alchemy 合作伙伴门户](https://alchemyportal.azurewebsites.net)", 并在 "url" 字段中输入文件名。 确保查看并发布的见解显示 "是", 然后单击 "更新规则"。 **(这将在门户的新版本中显示 prettier-即将发布。)**
