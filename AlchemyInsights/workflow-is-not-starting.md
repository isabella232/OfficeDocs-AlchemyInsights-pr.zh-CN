...
- SharePoint 2010 工作流在启动时延迟。
    ...
    如果工作流是复杂的可扩展对象标记语言 (XMOL), 则编译可能会很慢。 请[](https://support.microsoft.com/en-us/kb/3043697)查看本文。

    应简化工作流或使用 Microsoft SharePoint 2013 工作流平台类型对其进行重新设计。

    此外, 如果您的工作流历史记录增长很大, 您可能需要清除项目或创建新的历史记录列表。
...
想要在 SharePoint Online 中尝试 Micrsoft 流？
