...
如果文档、工作表或演示文稿已锁定, 无法进行编辑, 则可能是因为其他人正在编辑该文件, 或者这些文件已签出。让我们快速看看[可能无法编辑该文件](https://support.office.com/article/why-can-t-i-edit-this-file-97315f48-aa5e-49d3-a4ae-a14b73daf87b)的原因。

注意: 具有签出的库、必需的列/元数据或将草稿项目安全性设置为只有用户可以在库的版本设置中对项目进行审批的用户才可以对其进行编辑。
