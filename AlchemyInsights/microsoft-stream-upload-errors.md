...
<span data-ttu-id="d24be-103">如果您在 Microsoft Stream 中收到上传错误，请参阅[Stream 上载错误](https://docs.microsoft.com/stream/portal-understanding-upload-errors)。</span><span class="sxs-lookup"><span data-stu-id="d24be-103">If you are receiving upload errors in Microsoft Stream, please see [Stream upload errors](https://docs.microsoft.com/stream/portal-understanding-upload-errors).</span></span>
