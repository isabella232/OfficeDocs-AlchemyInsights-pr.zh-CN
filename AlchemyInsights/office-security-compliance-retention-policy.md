...
- 转到安全性和合规性 > 数据治理 > 保留
  - 请[参阅本文](https://docs.microsoft.com/office365/securitycompliance/retention-policies)

- 转到安全与合规 > 电子数据展示> 高级电子数据展示 
  - 请[参阅本文](https://docs.microsoft.com/office365/securitycompliance/ediscovery-cases)
