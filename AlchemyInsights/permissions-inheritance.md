...
ms.locfileid: "29459736"
---
# <a name="how-permissions-inheritance-works-in-sharepoint"></a><span data-ttu-id="2dd1e-102">权限继承在 SharePoint 中的工作方式</span><span class="sxs-lookup"><span data-stu-id="2dd1e-102">How permissions inheritance works in SharePoint</span></span>

<span data-ttu-id="2dd1e-p101">默认情况下，在 SharePoint 中的权限继承从较高层次结构中。因此，文件从其权限继承其权限继承的网站，其权限继承的网站集库文件夹继承其权限。</span><span class="sxs-lookup"><span data-stu-id="2dd1e-p101">By default, permissions in SharePoint are inherited from higher up in the hierarchy. So a file inherits its permissions from the folder, which inherits its permissions from the library, which inherits its permissions from the site, which inherits its permissions from the site collection.</span></span>
  
<span data-ttu-id="2dd1e-105">有关删除独有权限和还原继承的信息，请参阅[编辑和管理列表或库的权限](https://go.microsoft.com/fwlink/?linkid=869946)。</span><span class="sxs-lookup"><span data-stu-id="2dd1e-105">For info about removing unique permissions and restoring inheritance, see [Edit and manage permissions for a list or library](https://go.microsoft.com/fwlink/?linkid=869946).</span></span>
