...
---
# <a name="common-issues-and-resolutions-with-office-apps"></a>Office 应用的常见问题和解决方法

以下是一些常见的请求帮助的 Office 应用主题：
...
- **解决** [Office 应用故障、停止响应或不启动的问题](https://docs.microsoft.com/alchemyinsights/office-apps-don't-launch-start)
