...
如果您使用的是 web 上的 Outlook，并且出现 **错误，** 则表示出现 **X-OWA-错误： InvalidLicenseException**、您的 exchange Online 许可证未正确分配或最近已过期。 您的管理员可以通过执行以下步骤为您分配许可证：
...
3. 在打开的 " **产品许可证** " 页中，选择适当的 " **位置** " 值，并分配包含 Exchange Online (的许可证。展开许可证以查看其详细信息) 。 完成时，请单击“保存”****。
