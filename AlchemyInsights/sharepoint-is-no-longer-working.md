...
1. SharePoint 可能发生服务运行状况问题。 有关详细信息，请参阅[服务运行状况仪表板](https://admin.microsoft.com/AdminPortal/Home#/servicehealth)。
...
3. 浏览器问题可能会阻止用户打开 SharePoint。 请求用户尝试其浏览器的专用模式并重新登录 SharePoint。