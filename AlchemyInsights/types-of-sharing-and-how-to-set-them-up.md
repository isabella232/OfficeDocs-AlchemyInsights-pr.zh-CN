...
ms.locfileid: "54092257"
---
# <a name="different-types-of-shared-outlook-calendars-and-how-to-set-them-up"></a>共享 Outlook 日历的各种类型及其设置方法

- [创建共享邮箱](https://docs.microsoft.com/microsoft-365/admin/email/create-a-shared-mailbox)

- [会议室和设备邮箱](https://docs.microsoft.com/microsoft-365/admin/manage/room-and-equipment-mailboxes)
